...
<summary>CylinderJet2D</summary>
    ...
    python runscripts/train/train_sb3.py -m \
...
<summary>CylinderJet2D</summary>
    ...
    python runscripts/train/run_dpc.py -m \
        env_id=CylinderJet2D-easy-v0,CylinderJet2D-medium-v0,CylinderJet2D-hard-v0 \ 
        seed=range(5)
...
<summary>CylinderJet2D</summary>
    ...
    python runscripts/train/train_tdmpc.py -m \
        env_id=CylinderJet2D-easy-v0,CylinderJet2D-medium-v0,CylinderJet2D-hard-v0 \ 
        seed=range(5)
...
<summary>RBC2D</summary>
    ...
    python runscripts/train/train_tdmpc.py -m --config-name=stress_test_sb3 \
...
## Classic Baseline (PD Controller)

<details>
<summary>RBC2D</summary>
    <br>

    python runscripts/train/run_PD_RBC.py -m \
        env_id=RBC2D-easy-v0,RBC2D-medium-v0,RBC2D-hard-v0 \ 
        seed=range(5) \
        rl_mode=sarl
